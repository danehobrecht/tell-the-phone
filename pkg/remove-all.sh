...
adb shell pm uninstall -k --user 0 com.sonim.vowifiauth
adb shell pm uninstall -k --user 0 com.sonim.exif
adb shell pm uninstall -k --user 0 com.sonim.gif
adb shell pm uninstall -k --user 0 com.sonim.camera
adb shell pm uninstall -k --user 0 com.sonim.backup
adb shell pm uninstall -k --user 0 com.sonim.ble.connect.xp8
adb shell pm uninstall -k --user 0 com.sonim.entitlement
adb shell pm uninstall -k --user 0 com.sonim.safeguard
adb shell pm uninstall -k --user 0 com.sonim.progtorch
adb shell pm uninstall -k --user 0 com.sonim.carrier
adb shell pm uninstall -k --user 0 com.sonim.launcher
adb shell pm uninstall -k --user 0 com.sonim.scout.stealthmode
adb shell pm uninstall -k --user 0 com.sonim.scout.callscreening
adb shell pm uninstall -k --user 0 com.sonim.scout.warranty
adb shell pm uninstall -k --user 0 com.sonim.scout.contact
adb shell pm uninstall -k --user 0 com.sonim.sonimcustomercare.ten
adb shell pm uninstall -k --user 0 com.sonim.scout.mdmhelper
adb shell pm uninstall -k --user 0 com.sonim.ble.connect.xp8
adb shell pm uninstall -k --user 0 com.sonimtech.spcc
adb shell pm uninstall -k --user 0 com.sonimtech.setupwizard.ten
